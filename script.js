...
const weatherAPIKey = "147f30640485387b1b2c6150a62c9bc5";
    ...
    navigator.geolocation.getCurrentPosition(position => {
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                document.querySelector("#weather").innerHTML = "Uable to get the weather info. Try again later.";
            }));
...
function populateProducts(productList) {
    ...
    productList.forEach(function (product, index) {
        //create the HTML element for the individual prodcut
        ...
        ///add all chil HTML elements for the product
        productElm.append(productImage);
        productElm.append(productDetails);
        ///add the individual to the prodcut section
